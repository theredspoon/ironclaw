...
require_in "${mirror_workflow}" 'name:[[:space:]]*Preserve deployment target workflows' "deployment target workflow overlay step"
require_in "${mirror_workflow}" 'git checkout "refs/remotes/deployment_mirror/\$\{TARGET_BRANCH\}" -- \.github/workflows' "deployment target workflows restored"
