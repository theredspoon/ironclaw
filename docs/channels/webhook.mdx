...
<Warning>
The unified webhook listener binds to `127.0.0.1:8080` by default. If you need external webhook delivery without a tunnel, set `WEBHOOK_HOST=0.0.0.0`.
</Warning>
...
<AccordionGroup>
  <Accordion title="Connection refused" icon="x-circle">
    ...
    - Verify `WEBHOOK_PORT` is correct
