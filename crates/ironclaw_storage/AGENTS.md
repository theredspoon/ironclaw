...
- Own storage mechanics only: backend identity, redacted errors, migration descriptors, pagination, serialization helpers, primitive `BlobStore`/`RecordStore` traits, and future append-log/lock/transaction/encrypted-blob primitives.
