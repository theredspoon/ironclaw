...
pub(crate) const INSTALLATION_ID: &str = "matrix-default";
pub(crate) const MATRIX_EGRESS_HOST: &str = "matrix.org";
pub(crate) const MATRIX_CREDENTIAL_HANDLE: &str = "matrix-access-token";
