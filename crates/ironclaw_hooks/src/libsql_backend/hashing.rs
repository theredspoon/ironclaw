...
//! ([`crate::predicate_hash`]) so the durable DB identity contract has
...
//!
//! [`Digest`]: crate::predicate_hash::Digest

use crate::predicate_hash;
use crate::predicate_state::{InvocationKey, ValueKey, window_cutoff};
...
/// [`crate::predicate_state::window_cutoff`] so the overflow/boundary
