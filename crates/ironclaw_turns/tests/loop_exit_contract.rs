use ironclaw_turns::{
    ...
    LoopCheckpointStateRef, LoopCompleted, LoopCompletionKind, LoopExit, LoopExitId,
    LoopExitInvalidHandling, LoopExitValidationDecision, LoopExitValidationPolicy,
